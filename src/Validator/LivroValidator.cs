...
public class LivroValidator : AbstractValidator<Livro>
{
    public LivroValidator()
    {
        ...
        RuleFor(livro => livro.Autor)
            ...
            .Matches(@"^[a-zA-Zà-úÀ-Ú\s\-\'\,\.]+$").WithMessage("O nome do autor não pode conter números.")
        ...
        RuleFor(livro => livro.Genero)
            ...
            .Matches(@"^[a-zA-Zà-úÀ-Ú\s\-\'\,]+$").WithMessage("O gênero do livro não pode conter pontos ou números.")
